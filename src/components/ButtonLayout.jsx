    ...
    <div className="print:m-0 print:p-0">
      <div className="mb-6 space-y-4 print:hidden">
        <div className="flex items-center space-x-4">
          <label className="flex items-center px-4 py-2 bg-sky-600 text-white rounded cursor-pointer hover:bg-blue-700">
          ...
          <button
            onClick={handlePrint}
            className="px-4 py-2 bg-emerald-500 text-white rounded hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed"
            disabled={!image}
          >
            Print Layout
          </button>
